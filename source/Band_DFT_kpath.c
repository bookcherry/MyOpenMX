...
// {
//   homo_e = EigenVal[1][1][0][(int)Total_N_U-1]*Unit;
...
//     for (spin = 0; spin <= SpinP_switch; spin++)
//     {
//       if (EigenVal[ik][i_perk][spin][(int)Total_N_U-1]*Unit>homo_e)
//       {
//         homo_e = (EigenVal[ik][i_perk][spin][(int)Total_N_U-1])*Unit;
//       }
//     }
    
//   }
// }
// lumo_e = EigenVal[1][1][0][(int)Total_N_U]*Unit;
...
//     for (spin = 0; spin <= SpinP_switch; spin++)
//     {
//       if (EigenVal[ik][i_perk][spin][(int)Total_N_U]*Unit<lumo_e)
//       {
//         lumo_e = EigenVal[ik][i_perk][spin][(int)Total_N_U]*Unit;
//       }
//     } 
//   }
// }
