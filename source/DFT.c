...
double g;
int DN,BN,myid,numprocs,Ng1,Ng2,Ng3;
...
double DFT(int MD_iter, int Cnt_Now)
{
  ...
  ****************************************************/
  ...
  Calc_g(Density_Grid_D[0],Density_Grid_D[1],Density_Grid_D[2],Density_Grid_D[3]);
  Calc_Di_Pe(Kspace_grid1,Kspace_grid2,Kspace_grid3,SpinP_switch,EIGEN_Band,k_op,T_k_op);
