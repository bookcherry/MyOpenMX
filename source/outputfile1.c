                 ...
                 double ChemP_e0[2])
{
  ...
  if (myid==Host_ID){
	...
	fprintf(fp,"  Ucs:    constraint energy for spin orientation\n");
        ...
        fprintf(fp,"\n*******************************************************\n"); 
        fprintf(fp,"       Bandgap Estimator at MD =%2d        \n",MD_iter);
        fprintf(fp,"*******************************************************\n\n"); 
        fprintf(fp,"  g1 =    %20.12f\n",g1);
        fprintf(fp,"  g2 =    %20.12f\n",g2);
        fprintf(fp,"  KSGap =    %20.12f (eV)\n",KSGap);
        fprintf(fp,"  Di_Pe =    %20.12f\n",Di_Pe);
        fprintf(fp,"  g1:    int |nabla rho|/rho dr \n"); 
        fprintf(fp,"  g2:    int sqrt(|nabla rho|/rho) dr\n"); 
        fprintf(fp,"  KSGap:    kohn-sham gap\n"); 
        fprintf(fp,"  Di_Pe:    dielectric constant of Penn model\n"); 
